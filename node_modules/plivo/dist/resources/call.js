...
var CallInterface = exports.CallInterface = function (_PlivoResourceInterfa) {
  ...
  _createClass(CallInterface, [{
    ...
    value: function get(id) {
      ...
      var params = {};
      params.isVoiceRequest = 'true';
      return _get(CallInterface.prototype.__proto__ || Object.getPrototypeOf(CallInterface.prototype), 'get', this).call(this, id, params);
    }
...
var QueuedCallInterface = function (_PlivoResourceInterfa3) {
  ...
  _createClass(QueuedCallInterface, [{
    ...
    value: function list() {
      ...
      return new Promise(function (resolve, reject) {
        client('GET', action, { status: 'queued', isVoiceRequest: 'true' }).then(function (response) {
          var calls = [];
          response.body.calls.forEach(function (callUuid) {
