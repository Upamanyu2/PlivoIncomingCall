...
var Conference = exports.Conference = function (_PlivoResource) {
  ...
  _createClass(Conference, [{
    ...
    value: function muteMember(memberId) {
      ...
      var params = {};
      params.isVoiceRequest = 'true';
      return _get(Conference.prototype.__proto__ || Object.getPrototypeOf(Conference.prototype), 'executeAction', this).call(this, this.id + '/Member/' + memberId + '/Mute/', 'POST', params);
    }
    ...
    value: function deafMember(memberId) {
      ...
      var params = {};
      params.isVoiceRequest = 'true';
      return _get(Conference.prototype.__proto__ || Object.getPrototypeOf(Conference.prototype), 'executeAction', this).call(this, this.id + '/Member/' + memberId + '/Deaf/', 'POST', params);
    }
...
var ConferenceInterface = exports.ConferenceInterface = function (_PlivoResourceInterfa) {
  ...
  _createClass(ConferenceInterface, [{
    ...
    value: function get(id) {
      ...
      var params = {};
      params.isVoiceRequest = 'true';
      return _get(ConferenceInterface.prototype.__proto__ || Object.getPrototypeOf(ConferenceInterface.prototype), 'get', this).call(this, id, params);
    }
